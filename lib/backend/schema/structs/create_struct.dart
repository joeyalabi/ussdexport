...
class CreateStruct extends BaseStruct {
  CreateStruct({
    bool? canDebit,
    bool? canCredit,
    String? id,
  ...
  static CreateStruct fromMap(Map<String, dynamic> data) => CreateStruct(
  ...
  static CreateStruct? maybeFromMap(dynamic data) =>
      data is Map ? CreateStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static CreateStruct fromSerializableMap(Map<String, dynamic> data) =>
      CreateStruct(
  ...
  @override
  String toString() => 'CreateStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is CreateStruct &&
...
CreateStruct createCreateStruct({
  bool? canDebit,
  bool? canCredit,
  String? id,
  String? client,
