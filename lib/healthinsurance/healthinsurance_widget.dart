...
import 'healthinsurance_model.dart';
export 'healthinsurance_model.dart';

/// a page that allows a user apply for health insurance service, they can
/// choose from two plans; family or individual and fill in other needed
/// details and personal and health care questions
class HealthinsuranceWidget extends StatefulWidget {
  const HealthinsuranceWidget({super.key});

  static String routeName = 'healthinsurance';
  static String routePath = '/healthinsurance';
              ...
              child: Column(
                ...
                children: [
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: FlutterFlowChoiceChips(
                              options: [
                                ChipData('Individual Plan', Icons.person_sharp),
                                ChipData('Family Plan', Icons.family_restroom)
                              ],
                    ...
                    children: [
                      ...
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          ...
                          _model.dateOfBirth = _model.datePicked?.toString();
                          safeSetState(() {});
                        },
                      ),
                    ],
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 16.0),
                    child: FutureBuilder<List<PlateauLgasRow>>(
                      future: PlateauLgasTable().queryRows(
                        queryFn: (q) => q.order('lga_name', ascending: true),
                      ),
                      builder: (context, snapshot) {
                        ...
                        List<PlateauLgasRow> dropDownPlateauLgasRowList =
                            snapshot.data!;

                        return FlutterFlowDropDown<String>(
                          controller: _model.dropDownValueController1 ??=
                              FormFieldController<String>(null),
                          options: dropDownPlateauLgasRowList
                              .map((e) => e.lgaName)
                              .toList(),
                          onChanged: (val) =>
                  ...
                  Padding(
                    ...
                    child: FutureBuilder<List<WardsRow>>(
                      future: WardsTable().queryRows(
                        queryFn: (q) => q.order('ward_name', ascending: true),
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                        ...
                        List<WardsRow> dropDownWardsRowList = snapshot.data!;

                        return FlutterFlowDropDown<String>(
                          controller: _model.dropDownValueController2 ??=
                              FormFieldController<String>(null),
                          options: dropDownWardsRowList
                              .map((e) => e.wardName)
                              .toList(),
                          onChanged: (val) =>
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 16.0),
                    child: FutureBuilder<List<FacilitiesRow>>(
                      future: FacilitiesTable().queryRows(
                        queryFn: (q) =>
                            q.order('facility_name', ascending: true),
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                        ...
                        List<FacilitiesRow> dropDownFacilitiesRowList =
                            snapshot.data!;

                        return FlutterFlowDropDown<String>(
                          controller: _model.dropDownValueController3 ??=
                              FormFieldController<String>(null),
                          options: dropDownFacilitiesRowList
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        obscureText: false,
                        decoration: InputDecoration(
                          labelText: 'What health issues do you have?',
                          labelStyle:
                              FlutterFlowTheme.of(context).labelMedium.override(
                                    font: GoogleFonts.inter(
                                      fontWeight: FlutterFlowTheme.of(context)
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 8.0),
                              child: Text(
                                'Would you like to add a primary care physician?',
                                style: FlutterFlowTheme.of(context)
                                    .titleSmall
                                    .override(
                                      font: GoogleFonts.interTight(
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      _model.plaschemaform = await PlaschemaTable().insert({
                        'sponsor': _model.textController14.text,
                        'name': _model.textController1.text,
                        'address': _model.textController2.text,
                        'phone_number': _model.textController9.text,
                        'date_of_birth': _model.dateOfBirth,
                        'marital_status': _model.textController4.text,
                        'gender': _model.textController6.text,
                        'blood_group': _model.textController15.text,
                        'genotype': _model.textController2.text,
                        'disability': _model.textController5.text,
                        'next_of_kin': _model.textController10.text,
                        'next_of_kin_phone_no': _model.textController12.text,
                        'relationship_with_next_of_kin':
                            _model.textController11.text,
                        'lga_of_residence': _model.dropDownValue1,
                        'type_of_id': _model.dropDownValue3,
                        'facility_choice': _model.dropDownValue3,
                        'ward': _model.dropDownValue2,
                        'NIN': _model.textController13.text,
                        'Tier': _model.choiceChipsValue,
                      });
