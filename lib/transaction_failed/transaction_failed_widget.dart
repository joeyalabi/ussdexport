...
/// create a beautiful, modern, dark mode trasaction not succesful page for a
/// world class banking app
class TransactionFailedWidget extends StatefulWidget {
  ...
  static String routeName = 'TransactionFailed';
  static String routePath = '/transactionFailed';
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'We couldn\'t process your transaction at this time. Please check the details and try again.',
                          textAlign: TextAlign.center,
                          style:
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed(TransferWidget.routeName);
                          },
                          text: 'Try Again',
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            await launchUrl(Uri(
                                scheme: 'mailto',
                                path: 'support@iyapays.com',
                                query: {
                                  'subject': 'FAILED TRANSACTION',
                                  'body':
                                      'Hello, my transaction failed, my account number is;',
                                }
                                    .entries
