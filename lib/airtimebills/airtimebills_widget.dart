...
import 'airtimebills_model.dart';
export 'airtimebills_model.dart';
...
/// button to submit
class AirtimebillsWidget extends StatefulWidget {
  const AirtimebillsWidget({
    super.key,
  ...
  static String routeName = 'airtimebills';
  static String routePath = '/airtimebills';

  @override
  State<AirtimebillsWidget> createState() => _AirtimebillsWidgetState();
}

class _AirtimebillsWidgetState extends State<AirtimebillsWidget> {
  late AirtimebillsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AirtimebillsModel());
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    StreamBuilder<List<BuyairtimeRow>>(
                                      stream: _model
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<BuyairtimeRow>
                                            searchdropdownBuyairtimeRowList =
                                            snapshot.data!;
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if ((_model.apiResult1pg?.succeeded ?? true)) {
                                context.pushNamed(
                                  SuccesfulAirtimeWidget.routeName,
                                  queryParameters: {
