...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xE112AC83);
  late Color secondary = const Color(0xFF1F4037);
  late Color tertiary = const Color(0xFF3D3D3D);
  late Color alternate = const Color(0xFF2A3B47);
  late Color primaryText = const Color(0xFFE4E4E7);
  late Color secondaryText = const Color(0xFF71717A);
  late Color primaryBackground = const Color(0xFF1D2428);
  late Color secondaryBackground = const Color(0xFF18181B);
  late Color accent1 = const Color(0xFF27272A);
  late Color accent2 = const Color(0xFF2D5A52);
  late Color accent3 = const Color(0xFF3F3F46);
  late Color accent4 = const Color(0xFF52525B);
  late Color success = const Color(0xFF22543D);
