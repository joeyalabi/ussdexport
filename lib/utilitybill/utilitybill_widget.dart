...
import 'utilitybill_model.dart';
export 'utilitybill_model.dart';
...
class UtilitybillWidget extends StatefulWidget {
  const UtilitybillWidget({
    super.key,
    this.accountNumber,
    this.phoneNumber,
    this.password,
  ...
  static String routeName = 'Utilitybill';
  static String routePath = '/utilitybill';

  @override
  State<UtilitybillWidget> createState() => _UtilitybillWidgetState();
}

class _UtilitybillWidgetState extends State<UtilitybillWidget> {
  late UtilitybillModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UtilitybillModel());
                                  ...
                                  StreamBuilder<List<BuypowerRow>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return FlutterFlowDropDown<String>(
                                        ...
                                        searchHintText: 'Search for DISCO',
                                        icon: Icon(
