                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    _model.loginrequest =
                                        await UserdetailsTable().queryRows(
                                      queryFn: (q) => q
                                          .eqOrNull(
                                            'client',
                                    ...
                                    FFAppState().vidd =
                                        _model.loginrequest!.firstOrNull!.id;
                                    safeSetState(() {});
                                    ...
                                    context.pushNamed(
                                      ...
                                      queryParameters: {
                                        'identityId': serializeParam(
                                          _model.loginrequest?.firstOrNull
                                              ?.identityId,
                                          ParamType.String,
                                        ),
                                        'id': serializeParam(
                        ...
                        children: [
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(8.0),
                                      child: Image.asset(
                                        'assets/images/Central_Bank_of_Nigeria_CBN_Logo-527x700.png',
                                        width: 30.0,
                                        height: 40.0,
                                        fit: BoxFit.cover,
                                      ),
                          ...
                          Align(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                              child: Image.asset(
                                'assets/images/NDIC-ICON-removebg-preview.png',
                                width: 77.8,
                                height: 50.0,
                                fit: BoxFit.cover,
                              ),
