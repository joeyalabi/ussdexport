...
class TransferWidget extends StatefulWidget {
  ...
  static String routePath = '/transfer';
...
class _TransferWidgetState extends State<TransferWidget> {
  ...
  void initState() {
    ...
    _model.textController2 ??=
        TextEditingController(text: FFAppState().loginaccname);
                    ...
                    child: Column(
                      ...
                      children: [
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: FFAppState().loginaccname,
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inter(
                                  ...
                                  StreamBuilder<List<BanklistRow>>(
                                    stream: _model
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            _model.apiResultb68 =
                                await IyaSafeHavenGroup.transferCall.call(
                              debitAccountNumber: widget.accountNumber,
                              beneficiaryBankCode: _model.searchdropdownValue,
                              beneficiaryAccountNumber:
                                  _model.textController1.text,
                              narration: _model.textController4.text,
                              nameEnquiryReference:
                                  FFAppState().beneficiaryequirynumber,
                              amount: int.tryParse(_model.textController3.text),
                              ...
                              context.pushNamed(
                                ...
                                queryParameters: {
                                  ...
                                  'transactionStatus': serializeParam(
                                    IyaSafeHavenGroup.transferCall
                                        .transferstatus(
                                      (_model.apiResultb68?.jsonBody ?? ''),
                                    ),
                                    ParamType.String,
                                  ),
